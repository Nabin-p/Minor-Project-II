                            ...
                            <div class="col-md-4 mb-4">
                                <div class="p-3 border bg-light shadow-sm">
                                    ...
                                    <form action="{{route('school.session.store')}}" method="POST">
                                        @csrf
                                        <div class="mb-3">
                                            <input type="text" class="form-control form-control-sm" placeholder="2024/25" aria-label="Current Session" name="session_name" required>
                                        </div>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="p-3 border bg-light shadow-sm">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text" class="form-control form-control-sm" placeholder="1st" aria-label="Semester name" name="semester_name" required>
                                    </div>
                                    <div class="mt-2">
